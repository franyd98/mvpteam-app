  ...
  if (viewingClient !== null) {
    ...
    return (
      <div className="min-h-screen bg-neutral-950 pb-10">
        ...
        <div className="flex items-center gap-1 px-4 py-3 max-w-3xl mx-auto border-b border-neutral-800">
          <button
          ...
          {clientViewTab === "checkin" && (
            loadingCheckIn ? (
              ...
              <div className="space-y-6">
                {/* Tabla Antropometría */}
                <AntroTable
                  weightLogs={clientCheckIn.weights}
                  perimLogs={clientCheckIn.perims}
                  foldLogs={clientCheckIn.folds}
                />
